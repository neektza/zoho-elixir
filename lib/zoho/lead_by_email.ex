defmodule Zoho.LeadByEmail do

  @loc "Leads"
  @resource Zoho.Lead

  def endpoint do
    "/#{@loc}/getSearchRecordsByPDC?authtoken=#{auth_key()}&scope=crmapi&newFormat=1selectColumns=Leads(LEADID,Lead Source)&searchColumn=email"
  end

  # searchValue: "joe@example.com"
  def get(params) do
    raw_get(params).data
  end
